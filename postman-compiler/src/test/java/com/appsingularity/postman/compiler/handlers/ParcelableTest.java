    ...
    public void testParcelableList() {
        JavaFileObject source = JavaFileObjects.forSourceString("test.Model",
                Joiner.on('\n').join(
                        ...
                        "@PostmanEnabled",
                        "public class Model implements Parcelable {",
                        "   List<MyParcelable> mMyParcelable;",
                        "   ArrayList<MyParcelable> mMyParcelables;",
                        "",
                        "   protected Model(Parcel in) {",
                        "     Postman.receive(this, in);",
                        "  }",
        ...
        JavaFileObject expectedSource = JavaFileObjects.forSourceString("test/Model$$Postman",
                Joiner.on('\n').join(
                        ...
                        "   @Override",
                        "   public void ship(final Model source, final android.os.Parcel dest, int flags) {",
                        "     if (source.mMyParcelable != null) {",
                        "       dest.writeByte((byte) 1);",
                        "       dest.writeList(source.mMyParcelable);",
                        "     } else {",
                        "       dest.writeByte((byte) 0);",
                        "     }",
                        "     if (source.mMyParcelables != null) {",
                        "       dest.writeByte((byte) 1);",
                        "       dest.writeList(source.mMyParcelables);",
                        "     } else {",
                        "       dest.writeByte((byte) 0);",
                        "     }",
                        "   }",
                        ...
                        "   public void receive(final Model target, final android.os.Parcel in) {",
                        "     if (in.readByte() == 1) {",
                        "       target.mMyParcelable = new java.util.ArrayList<>();",
                        "       in.readList(target.mMyParcelable, com.appsingularity.postman.compiler.handlers.MyParcelable.class.getClassLoader());",
                        "     }",
                        "     if (in.readByte() == 1) {",
                        "       target.mMyParcelables = new java.util.ArrayList<>();",
                        "       in.readList(target.mMyParcelables, com.appsingularity.postman.compiler.handlers.MyParcelable.class.getClassLoader());",
                        "     }",
                        "   }",
                        "}"
                ));
