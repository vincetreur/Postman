...
public class ParcelableListHandler extends AbsListHandler {
    @NonNull
    private final Types mTypes;
    @NonNull
    private final Elements mElements;

    public ParcelableListHandler(@NonNull Types types, @NonNull Elements elements) {
        super();
        mTypes = types;
        mElements = elements;
        ...
        if (typeKind == TypeKind.DECLARED) {
            ...
            if ("java.util.List".equals(typeAsElement.toString()) || "java.util.ArrayList".equals(typeAsElement.toString())) {
                ...
                if (typeArguments != null && !typeArguments.isEmpty()) {
                    ...
                    TypeElement typeElement = mElements.getTypeElement("android.os.Parcelable");
