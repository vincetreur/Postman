...
public class GenericObjectHandler extends AbsAttributeHandler {
    ...
    public GenericObjectHandler(@NonNull final String fqName) {
        mFQName = fqName;
    }
    ...
    protected boolean reveiveMethod(@NonNull MethodSpec.Builder receiveMethod, @NonNull Element element, @NonNull TypeKind typeKind) {
        receiveMethod.addStatement("target.$L = ($L) in.readValue($L.class.getClassLoader())", element.getSimpleName().toString(), mFQName, mFQName);
        return true;
    }
